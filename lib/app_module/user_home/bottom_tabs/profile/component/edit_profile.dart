...
class _EditProfileState extends State<EditProfile> {
  ...
  @override
  void initState() {
  authController.fullNameController.text=Get.find<UserController>().nameFirst.value;
  authController.lastNameController.text=Get.find<UserController>().last.value;
  authController.phoneController.text=Get.find<UserController>().getProfile.phone==null?"":Get.find<UserController>().getProfile.phone;
  authController.emailRegController.text=Get.find<UserController>().email.value;
  authController.addressController.text=Get.find<UserController>().getProfile.address==null?"":Get.find<UserController>().getProfile.address;
  authController.postalController.text=Get.find<UserController>().getProfile.postCode==null?"":Get.find<UserController>().getProfile.postCode;
  authController.updateLat(Get.find<UserController>().getProfile.lat.toString());
  authController.updateLng(Get.find<UserController>().getProfile.long.toString());
                                  ...
                                  child: Material(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: const BoxDecoration(
                                          borderRadius:
                                          BorderRadius.all(Radius.circular(100))),
                                      child: Get.find<UserController>().file == null
                                          ? Container(
                                        decoration: const BoxDecoration(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Obx(
                                                ...
                                                return Image.network(
                                                  ...
                                                  fit: Get.find<UserController>().image.value.isEmpty?BoxFit.cover: BoxFit.cover,
                                        ...
                                        child: ClipRRect(
                                          ...
                                          BorderRadius.circular(100),
                                          child: Image.file(
                                            Get.find<UserController>().file as File,
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                      ),
