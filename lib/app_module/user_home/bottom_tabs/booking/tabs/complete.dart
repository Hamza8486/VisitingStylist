...
import 'package:stylish_app/app_module/user_home/bottom_tabs/booking/component/give_rating.dart';
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: GestureDetector(
                                        onTap:
                                        homeController.getBookList.where((p0) => p0.status=="completed").toList()[index].review==null?
                                          ...
                                          showModalBottomSheet(
                                              ...
                                              builder: (context) =>  ReviewSheet(
                                                data:homeController.getBookList.where((p0) => p0.status=="completed").toList()[index] ,
                                              ));
                                        }:(){
                                          Get.to(UserDetail(data: homeController.getBookList.where((p0) => p0.status=="completed").toList()[index],),
