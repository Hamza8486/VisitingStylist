...
class ActiveJobList extends StatelessWidget {
  ActiveJobList({Key? key}) : super(key: key);
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: (){
                                  ...
                                  Get.put(StylishController()).updateEndLat(homeController.getBookList.where((p0) => p0.status=="active").toList()[index].lat.toString());
                                  Get.put(StylishController()).updateEndLng(homeController.getBookList.where((p0) => p0.status=="active").toList()[index].long.toString());
                              ...
                              children: [
                                  ...
                                  child: GestureDetector(
                                    onTap: (){
                                      ...
                                      showModalBottomSheet(
                                          ...
                                          isDismissible: true,
                                          context: context,
                                          builder: (context) =>  CancelStylishWidget(id:homeController.getBookList.where((p0) => p0.status=="active").toList()[index].id.toString(),
                                ...
                                Expanded(
                                  child: GestureDetector(
                                    onTap: (){
                                      FocusScope.of(context).unfocus();
                                      Get.to(ViewActiveBooking(data: homeController.getBookList.where((p0) => p0.status=="active").toList()[index],));
