...
class ViewActiveBooking extends StatelessWidget {
  ViewActiveBooking({Key? key,this.data,this.type}) : super(key: key);
  var data;
  var type;
              ...
              children: [
                ...
                Row(
                  children: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Padding(
                              padding:  EdgeInsets.symmetric(horizontal: Get.width*0.03,vertical: Get.height*0.01),
                              child: AppText(
                                title:"${data.client.firstName.toString()} ${data.client.lastName.toString()}",
                                size: AppSizes.size_13,
                                fontFamily: AppFont.medium,
                                fontWeight: FontWeight.w600,
                                color: AppColor.blackDarkColor,
                    ...
                    data.client.phone==null?Container():
                    SizedBox(width: Get.width*0.05,),
                    data.client.phone==null?Container():
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Padding(
                              padding:  EdgeInsets.symmetric(horizontal: Get.width*0.03,vertical: Get.height*0.01),
                              child: AppText(
                                title:data.client.phone.toString(),
                                size: AppSizes.size_13,
                                fontFamily: AppFont.medium,
                                fontWeight: FontWeight.w600,
                                color: AppColor.blackDarkColor,
